        ...
        <div className="container flex flex-col flex-1 px-6 py-12 mx-auto">
            <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
                <div className="text-white lg:w-1/2 lg:mx-6">
                    <h1 className="text-2xl font-semibold capitalize lg:text-3xl"> Feel Free to Message Us!</h1>

                    <p className="max-w-xl mt-6">
                    Have a question? We are here to help! Feel free to drop us a message anytime for quick and friendly assistance. 
                    </p>
